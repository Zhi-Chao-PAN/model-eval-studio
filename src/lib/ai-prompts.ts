...
- 全部用第一人称“我”来写整篇正文。不要使用“用户”“测试者”“测试人员”等任何第三人称称呼，也不要写“建议用户…”“提交到平台后请填写…”之类面向读者的话。`.trim()
}
...
- 继续保持第一人称表单提交口吻，不要写成给用户看的说明稿，也不要把自己称为“用户”“测试者”或“测试人员”。不要使用任何第三人称称呼，也不要写“建议用户…”“提交到平台后请填写…”之类面向读者的话。
