...
【产物验证截图解读】
${opts.verificationSummary || '未自动生成产物验证截图（可能因产物为非文本类型或截图生成失败）。'}
...
【产物效果反馈】
（必须结合产物内容和“产物验证截图解读”来写，以第一人称“我”描述自己核验产物后的真实反馈。如果有自动生成的验证截图，说明截图展示了产物的哪些内容，我核验后发现了什么；如果没有截图，明确指出未能自动生成验证截图，反馈只能基于上传产物文本和任务要求判断。反馈要具体：是否符合预期、有无错误遗漏、可用性如何。）
